...
$current = 'edit_resto.php';
require_once 'navigatie.php';
require_once "functions/get_user_info.php";

if(isset($_POST['editResto'])){
    ...
    try{
        $stmt = $db->prepare("UPDATE resto SET naam=:naam, adres=:adres WHERE id=:id");
...
if(isset($_GET['edit_id']) && !empty($_GET['edit_id'])){
    ...
    require("connectie.php");
    $stmt = $db->prepare("SELECT * FROM resto WHERE id=:sid");
...
?>
    <main>
        <div class="container">
            <div class="row">
                <form role="form" class="col s12" method="POST" action="edit_resto.php">
                    <div class="row">
                        <div class="container">
                            ...
                            <div class="col s12" >
                                <button id="editResto" name="editResto" class="btn waves-effect waves-light" type="submit" >Edit Resto
